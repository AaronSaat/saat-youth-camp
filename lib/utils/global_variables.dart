...
class GlobalVariables {
  ...
  static DateTime today = DateTime(2025, 12, 31); //[DEVELOPMENT NOTES] untuk keperluan testing
  static TimeOfDay timeOfDay = TimeOfDay(hour: 12, minute: 0); //[DEVELOPMENT NOTES] untuk keperluan testing
}

...
class GlobalVariables {
  ...
  static const String serverUrl = 'https://reg3.seabs.ac.id/';
  ...
  static DateTime today = DateTime.now(); // Gunakan tanggal sekarang
  static TimeOfDay timeOfDay = TimeOfDay.now(); // Gunakan waktu sekarang
}

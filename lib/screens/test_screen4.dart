...
class TestScreen4 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _TestScreen4State();
}

class _TestScreen4State extends State {
  int touchedIndex = -1;
  ...
  static FlDotPainter _getPaint(PainterType type, double size, Color color) {
    switch (type) {
      ...
      case PainterType.cross:
        return FlDotCrossPainter(color: color, size: size * 2, width: max(size / 5, 2));
    }
  }
          ...
          ScatterChart(
            ScatterChartData(
              ...
              gridData: FlGridData(
                ...
                getDrawingHorizontalLine: (value) => const FlLine(color: Colors.grey),
                drawVerticalLine: true,
                checkToShowVerticalLine: (value) => true,
                getDrawingVerticalLine: (value) => const FlLine(color: Colors.grey),
              ),
                ...
                touchTooltipData: ScatterTouchTooltipData(
                  ...
                  getTooltipItems: (ScatterSpot touchedBarSpot) {
                    ...
                    return ScatterTooltipItem(
                      'X: ',
                      textStyle: TextStyle(height: 1.2, color: color1, fontStyle: FontStyle.italic),
                      bottomMargin: 10,
                      children: [
                        TextSpan(
                          text: '${touchedBarSpot.x.toInt()} \n',
                          style: TextStyle(color: color2, fontStyle: FontStyle.normal, fontWeight: FontWeight.bold),
                        ),
                        TextSpan(
                          text: 'Y: ',
                          style: TextStyle(height: 1.2, color: color1, fontStyle: FontStyle.italic),
                        ),
                        TextSpan(
          ...
          Align(
            ...
            child: Padding(
              ...
              child: DropdownButton(
                ...
                items: PainterType.values.map((e) => DropdownMenuItem(value: e, child: Text(e.name))).toList(),

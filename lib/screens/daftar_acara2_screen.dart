...
class DaftarAcara2Screen extends StatefulWidget {
  const DaftarAcara2Screen({super.key});

  @override
  State<DaftarAcara2Screen> createState() => _DaftarAcara2ScreenState();
}

class _DaftarAcara2ScreenState extends State<DaftarAcara2Screen> {
  ...
  void loadAcara() async {
    ...
    try {
      final acaraList = await ApiService.getAcara(context, day);
      setState(() {

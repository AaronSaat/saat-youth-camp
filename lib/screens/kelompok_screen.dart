  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text(namaKelompok ?? 'Nama Kelompok', style: const TextStyle(color: Colors.white, fontSize: 16)),
        leading: IconButton(
                                        ...
                                        child: Container(
                                          ...
                                          child: Stack(
                                            ...
                                            children: [
                                              ...
                                              Positioned(
                                                right: 0,
                                                child: Icon(Icons.arrow_right_sharp, size: 32, color: Colors.white),
                                              ),
                                            ],
                                          ),
                                        ),

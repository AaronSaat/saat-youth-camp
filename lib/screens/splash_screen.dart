...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _bgFadeController = AnimationController(vsync: this, duration: const Duration(milliseconds: 500));
    _bgFadeAnimation = Tween<double>(
      begin: 1.0,
      end: 0.0,
    ).animate(CurvedAnimation(parent: _bgFadeController, curve: Curves.easeOut));

    _logoMoveController = AnimationController(vsync: this, duration: const Duration(milliseconds: 800));
    _logoPositionAnimation = Tween<Offset>(
      begin: Offset.zero,
      // end: const Offset(0, -1.25),
      end: const Offset(0, -0.65),
    ).animate(CurvedAnimation(parent: _logoMoveController, curve: Curves.easeInOut));
    ...
    ).animate(CurvedAnimation(parent: _textFadeController, curve: Curves.easeOut));
    ...
    Future.delayed(const Duration(seconds: 2), () async {
      ...
      if (getToken != null && getToken.isNotEmpty) {
        ...
        if (isValid) {
          ...
          await Future.wait([_logoMoveController.forward(), _textFadeController.forward()]);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        children: [
          FadeTransition(opacity: _bgFadeAnimation, child: Container(color: AppColors.primary)),
          Center(
            child: Column(
              ...
              children: [
                ...
                SlideTransition(
                  ...
                  child: ScaleTransition(
                    ...
                    //     image: const DecorationImage(image: AssetImage('assets/logos/story_saat.png'), fit: BoxFit.cover),
                    //     // boxShadow: [
                    //     //   BoxShadow(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(100),
                        image: const DecorationImage(image: AssetImage('assets/logos/redeemed.png'), fit: BoxFit.cover),
                      ),
                    ),
                  ),
                ),

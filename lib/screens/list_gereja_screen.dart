...
class ListGerejaScreen extends StatefulWidget {
  const ListGerejaScreen({Key? key}) : super(key: key);

  @override
  _ListGerejaScreenState createState() => _ListGerejaScreenState();
}

class _ListGerejaScreenState extends State<ListGerejaScreen> {
                              ...
                              return CustomCard(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => AnggotaGerejaScreen(id: gereja['gereja_id'] ?? 'Gereja???'),
                                    ),
                                  );
                                },

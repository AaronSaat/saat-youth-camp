                              ...
                              InkWell(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => FormKomitmenScreen(userId: userId, acaraHariId: 1),
                                    ),
                                  ).then((result) {
                                    if (result == 'reload') {
                                      initAll(); // reload dashboard
                                    ...
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => const DaftarAcaraScreen()),
                                          );
                                        },
                                        icon: const Icon(Icons.arrow_forward_ios, color: AppColors.black1),
                                      ),
                                    ],
                                  ),
                                  SizedBox(
                                                ...
                                                MaterialPageRoute(
                                                  builder:
                                                      (context) => DetailAcaraScreen(
                                                        id: _acaraList[index]["id"],
                                                        hari: _acaraList[index]["hari"],
                                                        userId: userId,
                                                      ),
                                                ),
                                              );
